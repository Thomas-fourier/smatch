...
cflags += -Wp,-MP,-MMD,$(@D)/.$(@F).d -I /usr/include/glib-2.0/ -I /usr/lib/x86_64-linux-gnu/glib-2.0/include/ `pkg-config --cflags --libs glib-2.0`
endif
